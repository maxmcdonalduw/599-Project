...
ADM1NAME = First sub-national administrative division name when the DHS sample is representative at the admin 1 level. The spelling of the name matches that of the final report. This variable will usually match v024 in the DHS recode file, although accents or alternate names may be used.
*NOTE: If survey is not representative at the admin 1 level, this field will be "NULL".

DHSREGCO = The integer region code associated with the DHS region created for sampling. This variable will match the hv023 variable in the DHS recode file for the Honduras 2011 DHS.
*NOTE:  In older templates, REPAR1DHS was used. This field has been renamed DHSREGCO. The REPAR1DHS field is no longer used. 

DHSREGNA = The name associated with the DHS region created for sampling.  The spelling of the name matches that of the final report. This variable will match the hv023 variable in the DHS recode file for the Honduras 2011 DHS, although accents or alternate names may be used.
