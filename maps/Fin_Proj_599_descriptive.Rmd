...
hn_data <- read.csv("https://github.com/arsell/599-Project/blob/master/data/cleandata.csv?raw=true")
hn_data <- na.omit(hn_data)
#hn_spatial <- read_sf(dsn ="https://github.com/arsell/599-Project/blob/master/maps", layer = "HNGE61FL.shp")
hn_spatial <- readOGR(dsn = "C:/users/arsell/documents/github/599-Project/maps/HNGE61FL.shp") 
...
hn_map1 <- readOGR('C:/users/arsell/documents/github/599-project/maps/gadm36_HND_1.shp') #SpatialPolygonDataFrame
...
pdf("avgs_by_region1.pdf", height=6, width=6)
...
pdf("avgs_by_region2.pdf", height=6, width=6)
...
pdf("avgs_by_region3.pdf", height=6, width=6)
